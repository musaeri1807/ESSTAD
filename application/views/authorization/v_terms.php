  ...
  <div class="container-fluid">
    <div class="card card-primary card-outline">
      ...
      <div class="card-body">
        <strong></strong>
        <div>
          <h3>Syarat dan Ketentuan Penggunaan Aplikasi</h3>
          ...
          <ol>
            ...
            <li><strong>Pembaruan Syarat dan Ketentuan:</strong> Syarat dan ketentuan ini dapat diperbarui dari waktu ke waktu tanpa pemberitahuan sebelumnya. Dengan melanjutkan penggunaan aplikasi ini setelah perubahan, Anda dianggap telah menyetujui perubahan tersebut.</li>
            <li><strong>Penghapusan Akses:</strong> Perusahaan berhak untuk membatasi akses atau mengakhiri akses Anda ke dalam aplikasi karyawan ini jika kami menemukan pelanggaran terhadap syarat dan ketentuan ini atau peraturan perusahaan lainnya.</li>
          </ol>
        </div>
