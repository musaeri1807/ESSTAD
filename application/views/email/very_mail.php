...
<head>
    ...
    <style type="text/css" rel="stylesheet" media="all">
        *:not(br):not(tr):not(html) {
        ...
        .button--blue {
            background-color: #010af8;
            border-top: 10px solid #010af8;
            border-right: 18px solid #010af8;
            border-bottom: 10px solid #010af8;
            border-left: 18px solid #010af8;
        }
                    ...
                    <tr>
                        <td class="email-masthead">
                            <a href="#" class="email-masthead_name">
                                ...
                                <img src="../../../assets/images/signin.png" alt="Logo ESSTAD" height="90">
                            </a>
                        </td>
                    </tr>
                    <!-- Email Body -->
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <table border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td>
                                                                            <a href="' . base_url() . 'auth/verifikasi?email=' . $email . '&token=' . urlencode($tokenn) . '" class="button button--green" target="' . base_url() . 'auth/verifikasi?email=' . $email . '&token=' . urlencode($tokenn) . '">' . $button . '</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                            ...
                            <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="content-cell" align="center">
                                        <p class="sub align-center">&copy; By . All rights reserved.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
